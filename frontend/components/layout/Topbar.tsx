          ...
          {notifOpen && (
            <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-xl border border-gray-100 py-2 z-50 animate-fade-in">
              <div className="px-4 py-2 border-b border-gray-50 flex justify-between items-center">
                ...
                <span className="text-xs text-cardinal bg-cardinal-50 px-2 py-0.5 rounded-full">3 New</span>
              </div>
              <div className="max-h-[300px] overflow-y-auto">
                <div className="px-4 py-3 hover:bg-gray-50 cursor-pointer border-b border-gray-50">
                  <p className="text-sm text-thunder">Project proposal approved</p>
                  <p className="text-xs text-slate mt-1">2 hours ago</p>
                </div>
                <div className="px-4 py-3 hover:bg-gray-50 cursor-pointer border-b border-gray-50">
                  <p className="text-sm text-thunder font-medium">New meeting scheduled</p>
                  <p className="text-xs text-slate mt-1">5 hours ago</p>
                </div>
                <div className="px-4 py-3 hover:bg-gray-50 cursor-pointer">
                  <p className="text-sm text-thunder font-medium">Logbook submission due</p>
                  <p className="text-xs text-slate mt-1">Yesterday</p>
                </div>
              </div>
            </div>
          )}
          ...
          {userMenuOpen && (
            <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-gray-100 py-1 z-50 animate-fade-in">
              <div className="px-4 py-3 border-b border-gray-50">
                <p className="text-sm font-medium text-thunder">User Profile</p>
                <p className="text-xs text-slate truncate">user@capstonex.com</p>
              </div>
              <div className="py-1">
                <button className="w-full text-left px-4 py-2 text-sm text-slate hover:text-thunder hover:bg-gray-50 transition-colors">
                  Settings
                </button>
                <button className="w-full text-left px-4 py-2 text-sm text-slate hover:text-thunder hover:bg-gray-50 transition-colors">
                  Support
              ...
              <div className="py-1 border-t border-gray-50">
                <button 
                  ...
                  className="w-full text-left px-4 py-2 text-sm text-cardinal hover:bg-red-50 transition-colors"
                >
                  Sign out
                </button>
              </div>
